...
public class bookSelfBookViewAdapter extends RecyclerView.Adapter<bookSelfBookViewAdapter.bookSelfViewHolder> {
    Context context;
    String[] bookName;
    int[] bookImage;

    public bookSelfBookViewAdapter(Context context, String[] bookName, int[] bookImage) {
